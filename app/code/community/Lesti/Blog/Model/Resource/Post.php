...
class Lesti_Blog_Model_Resource_Post extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    protected function _afterSaveStore(Mage_Core_Model_Abstract $object)
    {
    ...
    protected function _afterSaveCategory(Mage_Core_Model_Abstract $object)
    {
        ...
        $table  = $this->getTable('blog/category_post');
